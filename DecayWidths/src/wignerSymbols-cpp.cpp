//WignerSymbol class includes
#ifndef WIGNERSYMBOLS_CXX
#define WIGNERSYMBOLS_CXX

#include "commonFunctions_wigner.h"
...
WignerSymbols::WignerSymbols()
{
}

WignerSymbols::~WignerSymbols(){}

std::vector<double> WignerSymbols::wigner3j(double l2, double l3,
...
double WignerSymbols::wigner3j(double l1, double l2, double l3,
					double m1, double m2, double m3)
{
	// We enforce the selection rules.
	bool select(true);
...
std::vector<double> WignerSymbols::wigner6j(double l2, double l3,
...
double WignerSymbols::wigner6j(double l1, double l2, double l3,
					double l4, double l5, double l6)
{
	// We enforce the selection rules.
	bool select(true);
